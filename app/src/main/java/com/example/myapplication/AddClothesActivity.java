...
public class AddClothesActivity extends AppCompatActivity implements ClothesInputDialogFragment.ClothesInputDialogListener, ColorPickerDialogFragment.ColorPickerDialogListener {
    ...
    private static final String DIALOG_CLOTHES_INPUT_FRAGMENT_TAG = "com.example.myapplication.clothes_input";
    private static final String DIALOG_COLOR_PICKER_PRIMARY_FRAGMENT_TAG = "com.example.myapplication.color_picker_primary";
    private static final String DIALOG_COLOR_PICKER_SECONDARY_2_FRAGMENT_TAG = "com.example.myapplication.color_picker_secondary_2";
    private static final String DIALOG_COLOR_PICKER_SECONDARY_1_FRAGMENT_TAG = "com.example.myapplication.color_picker_secondary_1";
    private static final String MCURRENTCACHEIMAGEPATH = "com.example.myapplication.mCurrentCacheImagePath";
    private static final String MCURRENTPRIMARYCOLOR = "com.example.myapplication.mCurrentPrimaryColor";
    private static final String MCURRENTSECONDARYCOLOR_1 = "com.example.myapplication.mCurrentSecondaryColor_1";
    private static final String MCURRENTSECONDARYCOLOR_2 = "com.example.myapplication.mCurrentSecondaryColor_2";
    private static final String EDIT_MODE = "com.example.myapplication.editMode";
    private static final String CURRENT_CLOTHES_ID = "com.example.myapplication.currentClothesId";
    ...
    @Override
    public void onColorPickerDialogPositiveClick(androidx.fragment.app.DialogFragment dialog, int color) {

...
public class EditOutfitActivity extends AppCompatActivity {
    ...
    public static final String OUTFIT_BUNDLE = "com.example.myapplication.outfitBundle";
    public static final String EDITED_OUTFIT_BUNDLE = "com.example.myapplication.editedOutfitBundle";
    public static final String CLOTHES_ID_TO_REMOVE = "com.example.myapplication.clothesIdToRemove";

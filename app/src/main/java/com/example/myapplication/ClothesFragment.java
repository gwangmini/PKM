...
public class ClothesFragment extends Fragment {
    ...
    private final static String SELECTEDCLOTHESIDSLIST = "example.myapplication.selectedClothesIdsList";
    private final static String SELECTMODE = "example.myapplication.selectMode";
    private final static String GROUPINGMODE = "example.myapplication.groupingMode";

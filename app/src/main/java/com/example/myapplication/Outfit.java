...
public class Outfit {
    ...
    public static final String OUTFIT_ID = "com.example.myapplication.outfitID";
    public static final String OUTFIT_LIST_CLOTHES_IDS = "com.example.myapplication.listClothesIDS";
